...
#pragma warning disable CS8619 // Nullability of reference types in value doesn't match target type
		private static readonly Func<SqlServerDbContext, long, CancellationToken, Task<LoginServerEntity?>> getByIdNoTrackingQuery =
			EF.CompileAsyncQuery((SqlServerDbContext context, long serverId, CancellationToken ct) =>
...
#pragma warning restore CS8619
		...
		public LoginServerService(ISqlServerDbContextFactory dbContextFactory) : base(dbContextFactory)
		{
		}
