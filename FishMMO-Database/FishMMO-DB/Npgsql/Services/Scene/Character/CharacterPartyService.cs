...
#pragma warning disable CS8619 // Nullability of reference types in value doesn't match target type
		private static readonly Func<SqlServerDbContext, long, CancellationToken, Task<CharacterPartyEntity?>> getPartyMembershipQuery =
...
#pragma warning restore CS8619
		...
		/// </summary>
		private static readonly Func<SqlServerDbContext, long, CancellationToken, Task<List<CharacterPartyEntity>>> getPartyMembersQuery =
		...
		/// </summary>
		private static readonly Func<SqlServerDbContext, long, CancellationToken, Task<int>> getPartyMemberCountQuery =
			EF.CompileAsyncQuery((SqlServerDbContext context, long partyId, CancellationToken ct) =>
				context.CharacterParties
					.AsNoTracking()
					.Where(p => p.PartyID == partyId)
		...
		public CharacterPartyService(ISqlServerDbContextFactory dbContextFactory) : base(dbContextFactory)
		{
		}
