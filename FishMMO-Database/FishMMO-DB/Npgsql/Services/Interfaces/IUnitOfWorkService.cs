...
namespace FishMMO.Database.SqlServer.Services.Interfaces
{
	...
	/// </summary>
	/// <remarks>
	/// A unit of work establishes an ambient <c>SqlServerDbContext</c> and an explicit transaction for the
	...
	public interface IUnitOfWorkService
	{
		...
		/// </returns>
		/// <remarks>
		/// The returned unit of work establishes an ambient <c>SqlServerDbContext</c>.
